...
class Game():
    ...
    def choose_difficulty(self):
        ...
        self.easy_text = self.font.render("Easy", True, self.WHITE)
        self.normal_text = self.font.render("Normal", True, self.WHITE)
        self.hard_text = self.font.render("Hard", True, self.WHITE)
            ...
            for event in pygame.event.get():
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_LEFT:
                        ...
                        break  # No change in difficulty multiplier for normal difficulty
